...
VALUES (@default_template_id, 'Research Outputs', 8, @default_super_id, NOW(), @default_super_id, NOW());
SET @section_id := LAST_INSERT_ID();

INSERT INTO sectionTags (sectionId, tagId, createdById, created, modifiedById, modified)
VALUES (@section_id, 10, @default_super_id, NOW(), @default_super_id, NOW());
INSERT INTO sectionTags (sectionId, tagId, createdById, created, modifiedById, modified)
VALUES (@section_id, 11, @default_super_id, NOW(), @default_super_id, NOW());
INSERT INTO sectionTags (sectionId, tagId, createdById, created, modifiedById, modified)
VALUES (@section_id, 13, @default_super_id, NOW(), @default_super_id, NOW());
...
INSERT INTO versionedTemplates (templateId, active, version, versionType, versionedById, comment, name, description, ownerId, visibility, bestPractice, isDefault, languageId, created, createdById, modified, modifiedById)
  (SELECT id, 1, 'v3', 'PUBLISHED', createdById, 'Added a research output table question', name, description, ownerId, 'PUBLIC', bestPractice, isDefault, languageId, NOW(), createdById, NOW(), modifiedById
...
INSERT INTO versionedSections (versionedTemplateId, sectionId, name, introduction, requirements, guidance, displayOrder, bestPractice, created, createdById, modified, modifiedById)
  (SELECT @versioned_template_id, sectionId, name, introduction, requirements, guidance, displayOrder, bestPractice, NOW(), createdById, NOW(), modifiedById
   FROM versionedSections WHERE versionedTemplateId = @prior_versioned_template_id);

-- Then add the new research output section
INSERT INTO versionedSections (versionedTemplateId, sectionId, name, introduction, requirements, guidance, displayOrder, bestPractice, created, createdById, modified, modifiedById)
  (SELECT @versioned_template_id, id, name, introduction, requirements, guidance, displayOrder, bestPractice, NOW(), createdById, NOW(), modifiedById
...
INSERT INTO versionedSectionTags (versionedSectionId, tagId, created, createdById, modified, modifiedById)
  (SELECT newVSS.id, st.tagId, NOW(), st.createdById, NOW(), st.modifiedById
...
INSERT INTO versionedQuestions (versionedTemplateId, versionedSectionId, questionId, questionText, json, requirementText, guidanceText, sampleText, required, displayOrder, created, createdById, modified, modifiedById)
  (SELECT @versioned_template_id, newVSS.id, vsq.questionId, vsq.questionText, vsq.json, vsq.requirementText, vsq.guidanceText, vsq.sampleText, vsq.required, vsq.displayOrder, NOW(), vsq.createdById, NOW(), vsq.modifiedById
   FROM versionedSections AS vss
...
INSERT INTO versionedSectionTags (versionedSectionId, tagId, created, createdById, modified, modifiedById)
  (SELECT @versioned_section_id, tagId, NOW(), createdById, NOW(), modifiedById
   FROM sectionTags WHERE sectionId = @section_id);

INSERT INTO versionedQuestions (versionedTemplateId, versionedSectionId, questionId, questionText, json, requirementText, guidanceText, sampleText, required, displayOrder, created, createdById, modified, modifiedById)
  (SELECT @versioned_template_id, @versioned_section_id, id, questionText, json, requirementText, guidanceText, sampleText, required, displayOrder, NOW(), createdById, NOW(), modifiedById
