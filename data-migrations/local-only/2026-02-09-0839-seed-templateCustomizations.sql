...
INSERT INTO templateCustomizations (affiliationId, templateId, currentVersionedTemplateId, status, migrationStatus, isDirty, latestPublishedDate, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @nsf_gen_id, @v_nsf_gen_id, 'PUBLISHED', 'OK', 0, NOW(), @admin_id, NOW(), @admin_id, NOW());
SET @ok_gen_id := (SELECT id FROM templateCustomizations WHERE affiliationId = @affiliation_uri AND templateId = @nsf_gen_id);
INSERT INTO versionedTemplateCustomizations (affiliationId, templateCustomizationId, currentVersionedTemplateId, active, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @ok_gen_id, @v_nsf_gen_id, 1, @admin_id, NOW(), @admin_id, NOW());
...
INSERT INTO templateCustomizations (affiliationId, templateId, currentVersionedTemplateId, status, migrationStatus, isDirty, latestPublishedDate, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @nsf_phy_id, @v_nsf_phy_id, 'PUBLISHED', 'STALE', 1, NOW(), @admin_id, NOW(), @admin_id, NOW());
SET @ok_phy_id := (SELECT id FROM templateCustomizations WHERE affiliationId = @affiliation_uri AND templateId = @nsf_phy_id);
INSERT INTO versionedTemplateCustomizations (affiliationId, templateCustomizationId, currentVersionedTemplateId, active, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @ok_phy_id, @v_nsf_phy_id, 1, @admin_id, NOW(), @admin_id, NOW());
...
INSERT INTO templateCustomizations (affiliationId, templateId, currentVersionedTemplateId, status, migrationStatus, isDirty, latestPublishedDate, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @nsf_bio_id, @v_nsf_bio_id, 'PUBLISHED', 'ORPHANED', 0, NOW(), @admin_id, NOW(), @admin_id, NOW());
SET @ok_bio_id := (SELECT id FROM templateCustomizations WHERE affiliationId = @affiliation_uri AND templateId = @nsf_bio_id);
INSERT INTO versionedTemplateCustomizations (affiliationId, templateCustomizationId, currentVersionedTemplateId, active, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @ok_bio_id, @v_nsf_bio_id, 1, @admin_id, NOW(), @admin_id, NOW());
...
INSERT INTO templateCustomizations (affiliationId, templateId, currentVersionedTemplateId, status, migrationStatus, isDirty, latestPublishedDate, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @nsf_dms_id, @v_nsf_dms_id, 'PUBLISHED', 'OK', 1, NOW(), @admin_id, NOW(), @admin_id, NOW());
SET @ok_dms_id := (SELECT id FROM templateCustomizations WHERE affiliationId = @affiliation_uri AND templateId = @nsf_dms_id);
INSERT INTO versionedTemplateCustomizations (affiliationId, templateCustomizationId, currentVersionedTemplateId, active, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @ok_dms_id, @v_nsf_dms_id, 1, @admin_id, NOW(), @admin_id, NOW());
...
INSERT INTO templateCustomizations (affiliationId, templateId, currentVersionedTemplateId, status, migrationStatus, isDirty, latestPublishedDate, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @nsf_ehr_id, @v_nsf_ehr_id, 'DRAFT', 'OK', 1, NOW(), @admin_id, NOW(), @admin_id, NOW());
SET @ok_ehr_id := (SELECT id FROM templateCustomizations WHERE affiliationId = @affiliation_uri AND templateId = @nsf_ehr_id);
INSERT INTO versionedTemplateCustomizations (affiliationId, templateCustomizationId, currentVersionedTemplateId, active, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @ok_ehr_id, @v_nsf_ehr_id, 1, @admin_id, NOW(), @admin_id, NOW());
...
INSERT INTO templateCustomizations (affiliationId, templateId, currentVersionedTemplateId, status, migrationStatus, isDirty, latestPublishedDate, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @nsf_ast_id, @v_nsf_ast_id, 'DRAFT', 'OK', 1, NOW(), @admin_id, NOW(), @admin_id, NOW());
SET @ok_ast_id := (SELECT id FROM templateCustomizations WHERE affiliationId = @affiliation_uri AND templateId = @nsf_ast_id);
INSERT INTO versionedTemplateCustomizations (affiliationId, templateCustomizationId, currentVersionedTemplateId, active, createdById, created, modifiedById, modified) VALUES (@affiliation_uri, @ok_ast_id, @v_nsf_ast_id, 1, @admin_id, NOW(), @admin_id, NOW());
