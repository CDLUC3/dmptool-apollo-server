...
describe('findBy functions', () => {
  ...
  it('findById returns the UserEmail', async () => {
    ...
    expect(mockQuery).toHaveBeenLastCalledWith(context, expectedSql, [id.toString()], 'Test', undefined);
  ...
  it('findByUserIdAndEmail returns the UserEmail', async () => {
    ...
    expect(mockQuery).toHaveBeenCalledTimes(1);
    expect(mockQuery).toHaveBeenLastCalledWith(context, expectedSql, [id.toString(), email], 'Test', undefined);
    expect(result).toEqual(mockUserEmail);
  });
  ...
  it('findByEmail returns the UserEmail', async () => {
    ...
    expect(mockQuery).toHaveBeenCalledTimes(1);
    expect(mockQuery).toHaveBeenLastCalledWith(context, expectedSql, [mockUserEmail.email], 'Test', undefined);
    expect(result).toEqual([mockUserEmail]);
  });
