...
-- Custom question attached to the custom section (second one)
INSERT INTO customQuestions (templateCustomizationId, sectionType, sectionId, pinnedQuestionType, pinnedQuestionId, migrationStatus, questionText, json, requirementText, guidanceText, sampleText, useSampleTextAsDefault, createdById, created, modifiedById, modified)
  VALUES (@ok_ast_id, 'BASE', @nsf_ast_sec_id, 'BASE', NULL,'OK', 'Custom question', '{"type":"text","attributes":{"maxLength":255},"meta":{"schemaVersion":"1.0"}}', 'Custom requirements', 'Custom guidance', 'Custom sample text', 0, @admin_id, NOW(), @admin_id, NOW());
SET @ok_ast_cust_quest_id := (SELECT id FROM customQuestions WHERE templateCustomizationId = @ok_ast_id AND sectionType = 'BASE' AND sectionId = @nsf_ast_sec_id AND pinnedQuestionType = 'BASE' AND pinnedQuestionId IS NULL);

INSERT INTO versionedCustomQuestions (versionedTemplateCustomizationId, customQuestionId, versionedSectionType, versionedSectionId, pinnedVersionedQuestionType, pinnedVersionedQuestionId, questionText, json, requirementText, guidanceText, sampleText, useSampleTextAsDefault, createdById, created, modifiedById, modified)
  VALUES (@v_ok_ast_id, @ok_ast_cust_quest_id, 'BASE', @v_nsf_ast_sec_id, 'BASE', NULL,'Custom question', '{"type":"text","attributes":{"maxLength":255},"meta":{"schemaVersion":"1.0"}}', 'Custom requirements', 'Custom guidance', 'Custom sample text', 0,@admin_id, NOW(), @admin_id, NOW());

INSERT INTO customQuestions (templateCustomizationId, sectionType, sectionId, pinnedQuestionType, pinnedQuestionId, migrationStatus, questionText, json, requirementText, guidanceText, sampleText, useSampleTextAsDefault, createdById, created, modifiedById, modified)
  VALUES (@ok_ast_id, 'BASE', @nsf_ast_sec_id, 'BASE', @nsf_ast_quest_id,'OK', 'Custom question', '{"type":"text","attributes":{"maxLength":255},"meta":{"schemaVersion":"1.0"}}', 'Custom requirements', 'Custom guidance', 'Custom sample text', 0, @admin_id, NOW(), @admin_id, NOW());
SET @ok_ast_cust_quest_id2 := (SELECT id FROM customQuestions WHERE templateCustomizationId = @ok_ast_id AND sectionType = 'BASE' AND sectionId = @nsf_ast_sec_id AND pinnedQuestionType = 'BASE' AND pinnedQuestionId = @nsf_ast_quest_id);

INSERT INTO versionedCustomQuestions (versionedTemplateCustomizationId, customQuestionId, versionedSectionType, versionedSectionId, pinnedVersionedQuestionType, pinnedVersionedQuestionId, questionText, json, requirementText, guidanceText, sampleText, useSampleTextAsDefault, createdById, created, modifiedById, modified)
  VALUES (@v_ok_ast_id, @ok_ast_cust_quest_id2, 'BASE', @v_nsf_ast_sec_id, 'BASE', @v_nsf_ast_quest_id,'Custom question', '{"type":"text","attributes":{"maxLength":255},"meta":{"schemaVersion":"1.0"}}', 'Custom requirements', 'Custom guidance', 'Custom sample text', 0, @admin_id, NOW(), @admin_id, NOW());
